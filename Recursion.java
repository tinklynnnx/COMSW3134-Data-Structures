...
/******************************************************************************/
    ...
    public static boolean isPalindrome(String s) {
        if (s.length() <= 1) {
            return true;
        } else if (s.substring(0, 1).compareTo(s.substring(s.length() - 1)) == 0) {
...
/******************************************************************************/
    ...
    public static String separateIdentical(String s) {
        ...
        if (s.length() <= 1) {
            return s;
        } else if (s.substring(0, 1).compareTo(s.substring(1, 2)) == 0) {
            SeperatedString = SeperatedString + s.charAt(0) + "~";
        } else {
            SeperatedString = SeperatedString + s.charAt(0);
        }
        return SeperatedString + separateIdentical(s.substring(1));
    }
}
